...
insert into menu_item(id, created, name, price, menu_id, vegeterian, foodType) values (1 ,'2014-09-16', 'Päevapraad', 2.50, 1, false, 'MEAT');
insert into menu_item(id, created, name, price, menu_id, vegeterian, foodType) values (2 ,'2014-09-16', 'Seljanka', 1.50, 1, false, 'MEAT');
insert into menu_item(id, created, name, price, menu_id, vegeterian, foodType) values (3 ,'2014-09-16', 'Kanakoib tomatikastmes', 3.50, 1, true, 'FISH');
